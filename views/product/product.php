<?php
    ...
    $product = [];
    $id = $_GET['id'];  
    $category = ["1" => "electronics", "2" => "fashion", "3"=>"appliances"];
    ...
    <div class="container my-5 bg-bpod">
        <div class="container mt-5">
            ...
            <div class="row">
                <!-- Product Image -->
                <div class="col-md-6">
                    <img src="<?php echo BASE_URL.$product["image_url"]; ?>" alt="Product Image" class="img-fluid border border-danger border-10F" style="height:500px">
            </div>
